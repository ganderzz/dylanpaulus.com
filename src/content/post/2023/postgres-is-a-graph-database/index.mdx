...
description: "You don't need Neo4j to store graph data. Postgres handles nodes, edges, and recursive traversals with surprisingly good performance. Here's how."
