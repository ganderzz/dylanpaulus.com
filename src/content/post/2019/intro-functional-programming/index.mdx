...
description: "An accessible intro to functional programming built on three ideas (immutable data, pure functions, first-class functions) from a Boise Code Camp talk."
