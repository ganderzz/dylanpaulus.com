...
description: "How to resize an EBS volume on an AWS Mac EC2 instance. Bumping the volume size is only half the job; macOS needs the APFS container resized too."
tags: ["AWS", "Mac", "DevOps"]
date: "2024-12-03"
published: true
tip: true
